...
data_source_og = pooch.create(
    ...
    registry={
        ...
        "sea045_20230604T1832_delayed.nc": "sha256:afd88916df2e012ec701aaa8e215beb097734eaa121bfc56a59046d52c032dc0",
...
def load_sample_dataset(dataset_name="sea045_20230604T1832_delayed.nc"):
    """Download sample datasets for use with glidertest

    Args:
        dataset_name (str, optional): _description_. Defaults to "sea045_20230604T1832_delayed.nc".
